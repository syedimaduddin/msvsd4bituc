...
parser = argparse.ArgumentParser(description="4-bit Asynchronous Up Counter design generator")
parser.add_argument(
    "--specfile",
    required=True,
...
if jsonSpec["generator"] != "msvsd4bituc-gen":
    print('Error: Generator specification must be "msvsd4bituc-gen".')
    sys.exit(1)
...
mFilePublic1 = genDir + args.platform + ".model_msvsd4bituc"
